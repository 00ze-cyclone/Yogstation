...
/obj/item/gun/energy/e_gun/thermal_revolver
...
obj/item/gun/energy/e_gun/warcrime
	...
	desc = "A specialist energy weapon designed for thorough eradication of all life with minimal damages to the rest. Has three settings: scorch, declone and suffocate."
	icon_state = "sweeper"
	ammo_type = list(/obj/item/ammo_casing/energy/laser/scatter/incendiary, /obj/item/ammo_casing/energy/declone, /obj/item/ammo_casing/energy/anoxia)
